...
public class AmaryllisDecoration extends ImageDecoration {
	private static final String TEXTURE_NAME = "amaryllis";
	
	public AmaryllisDecoration(int tileSize, int worldX, int worldY) {
